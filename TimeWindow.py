...
class TimeWindow(QtWidgets.QMainWindow):
    # 创建时间控制信号
    timeControlSignal = QtCore.pyqtSignal(str)
    ...
    def __init__(self):
        ...
        # 设置窗口标题
        self.setWindowTitle('systick时间控制')
        ...
        self.send_button = QtWidgets.QPushButton('发送时间')
        ...
        self.send_button.clicked.connect(self.timeControl)
    ...
    def timeControl(self, time: str):
        self.timeControlSignal.emit(self.hour_text.text() + self.minute_text.text() + self.second_text.text())
